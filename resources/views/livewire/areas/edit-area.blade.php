<div>
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex justify-end space-x-2">
            <a href="{{ route('areas.show', $area) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                Cancel
            </a>
