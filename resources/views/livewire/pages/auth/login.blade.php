...
<div>
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Sign In to Your TODO Account</h2>
    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-between mt-4">
            @if (Route::has('password.request'))
                <a class="text-sm text-blue-600 dark:text-blue-500 hover:underline rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800" href="{{ route('password.request') }}" wire:navigate>
        ...
        <div class="text-center mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('register') }}" class="text-blue-600 dark:text-blue-500 hover:underline" wire:navigate>Sign Up</a>
            </p>
        </div>
    </form>
</div>